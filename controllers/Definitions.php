<?php namespace Utopigs\Sitemap\Controllers;
...
use Utopigs\Sitemap\Models\Definition;
...
class Definitions extends Controller
{
    ...
    public $requiredPermissions = ['utopigs.sitemap.access_definitions'];
    ...
    public function __construct()
    {
        ...
        SettingsManager::setContext('Utopigs.Sitemap', 'definitions');

        $this->addJs('/modules/backend/assets/js/october.treeview.js', 'core');
        $this->addJs('/plugins/utopigs/sitemap/assets/js/sitemap-definitions.js');
    }
    ...
    protected function redirectToThemeSitemap($theme)
    {
        ...
        $updateUrl = sprintf('utopigs/sitemap/definitions/update/%s', $model->getKey());
